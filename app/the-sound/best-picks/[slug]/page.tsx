...
export default function BestPicksSlugPage() {
  return (
      ...
      <section className="mx-auto flex max-w-6xl flex-col gap-5 px-4 py-8 md:px-8 lg:px-10">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <aside className="space-y-4 lg:sticky lg:top-24 self-start">
            <section className="border-[3px] border-slate-900 bg-[#DDF3FF] p-5 shadow-[5px_5px_0px_0px_rgba(15,23,42,1)]">
              ...
              <div className="mt-4 space-y-2">
                {article.checklist.map((item) => (
                  ...
                  >
                    <h3 className="font-anton text-sm uppercase tracking-[0.04em] text-slate-900">
                      {item.title}
                    </h3>
                    <p className="mt-1 font-sans text-sm leading-6 text-slate-700">
                      {item.body}
                    </p>
                  </div>
                ))}
            ...
            <section className="border-[3px] border-slate-900 bg-[#FDE7EA] p-5 shadow-[5px_5px_0px_0px_rgba(15,23,42,1)]">
              <h2 className="font-anton text-xl uppercase tracking-[0.16em] text-slate-900">
                Quick scan
              </h2>
              <ol className="mt-4 space-y-2 text-sm text-slate-700">
                <li className="border border-slate-900 bg-white p-3">
                ...
                <li className="border border-slate-900 bg-white p-3">
                  ...
                  Choose a setup that stays simple.
                </li>
              </ol>
            </section>
          </aside>
