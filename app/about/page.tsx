...
const points = [
  "We help people compare products without getting lost in endless review noise.",
  "We combine clear writing, thoughtful ranking, and a simple home-theater-inspired experience.",
  "We believe a good recommendation should feel useful, honest, and easy to understand.",
];
      ...
      <section className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-8 md:px-8 lg:px-10">
        <div className="border-4 border-slate-900 bg-slate-900 p-6 text-white shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] md:p-8">
          ...
          <h1 className="mt-3 font-anton text-4xl uppercase leading-none tracking-[0.04em] sm:text-5xl">
            We make product picks feel clearer
          </h1>
          <p className="mt-3 max-w-2xl font-sans text-sm leading-7 text-slate-300 sm:text-base">
            RankNest exists to simplify shopping decisions and make product comparisons feel more thoughtful, less noisy, and easier to trust.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <aside className="border-4 border-slate-900 bg-[#FFE7A2] p-6 shadow-[6px_6px_0px_0px_rgba(15,23,42,1)]">
            ...
            <p className="mt-3 font-sans text-sm leading-7 text-slate-800">
              We want people to feel informed without feeling overwhelmed. Good recommendations should feel calm, useful, and easy to act on.
            </p>
          </aside>
            ...
            {points.map((point, index) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <p className="font-sans text-sm leading-7 text-slate-700">
                    {point}
                  </p>
                </div>
              </article>
